...
inline std::uint8_t getBits(std::uint8_t value, std::uint8_t bitMask) {
 ...
 * newValue.
 */
inline std::uint8_t setBits(std::uint8_t oldValue, std::uint8_t newValue, std::uint8_t bitMask) {
